...
In order to support loading of multiple wallets in ultradashcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ultradashcoin.cpp.
...
Changes to ultradashcoin.cpp
----------------------
ultradashcoin.cpp is the entry point into ultradashcoin-qt, and as such, will require some minor modifications to provide hooks for
