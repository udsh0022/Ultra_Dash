...
Intro
-----
Ultradash Coin (UDSH) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Ultradash Coin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run ultradashcoin-qt.exe.

Ultradash Coin Core is the original Ultradash Coin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Ultradash Coin transactions;
