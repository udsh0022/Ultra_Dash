...
This mechanism has been integrated into Bitcore-Node-UltradashCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ultradashcoin/insight-api-ultradashcoin#web-socket-api](https://github.com/ultradashcoin/insight-api-ultradashcoin#web-socket-api)
* API: [https://github.com/ultradashcoin/insight-api-ultradashcoin#swifttx-transactions](https://github.com/ultradashcoin/insight-api-ultradashcoin#swifttx-transactions)
...
By default, the Ultradash Coin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Ultradash Coin Core daemon:
