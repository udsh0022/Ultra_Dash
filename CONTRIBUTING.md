Contributing to Ultradash Coin Core
==================================

The Ultradash Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Ultradash Coin Core project, and is not to be
confused with overall Ultradash Coin Network Protocol consensus changes.

Whether a pull request is merged into Ultradash Coin Core rests with the project merge
...
Patches that change Ultradash Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ultradash Coin consensus, it must have been
...
The project leader is the release manager for each Ultradash Coin Core release.
