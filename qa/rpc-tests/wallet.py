...
#   c) node1 mines 32 blocks, so now node 0 has 500000UDSH, node 1 has 4250UDSH, node2 has none.
#   d) node0 sends 601 UDSH to node2, in two transactions (301 UDSH, then 300 UDSH).
