...
#if defined(NDEBUG)
#error "Ultradash Coin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uudsh) are considered zero fee (for relaying and mining)
...
{
    RenameThread("ultradashcoin-scriptch");
