...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Ultradash Coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Ultradash Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ultradash Coin features */
        {"ultradashcoin", "masternode", &masternode, true, true, false},
        {"ultradashcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ultradashcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ultradashcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ultradashcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ultradashcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ultradashcoin", "startmasternode", &startmasternode, true, true, false},
        {"ultradashcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ultradashcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ultradashcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ultradashcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ultradashcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ultradashcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ultradashcoin", "mnbudget", &mnbudget, true, true, false},
        {"ultradashcoin", "preparebudget", &preparebudget, true, true, false},
        {"ultradashcoin", "submitbudget", &submitbudget, true, true, false},
        {"ultradashcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ultradashcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ultradashcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ultradashcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ultradashcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ultradashcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ultradashcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ultradashcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ultradashcoin", "mnsync", &mnsync, true, true, false},
        {"ultradashcoin", "spork", &spork, true, true, false},
        {"ultradashcoin", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"ultradashcoin", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"ultradashcoin", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"ultradashcoin", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"ultradashcoin", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"ultradashcoin", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> ultradashcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9238/\n";
}
