...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Ultradash Coin Core"),
     ...
     * override -datadir in the ultradashcoin.conf file in the default data directory
     * (to be consistent with ultradashcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
