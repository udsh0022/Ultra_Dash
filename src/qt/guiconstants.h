...
/* Ultradash Coin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "UltradashCoin"
#define QAPP_ORG_DOMAIN "savebitcoin.io"
#define QAPP_APP_NAME_DEFAULT "UltradashCoin-Qt"
#define QAPP_APP_NAME_TESTNET "UltradashCoin-Qt-testnet"
