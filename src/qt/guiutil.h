...
/** Utility functions used by the UltradashCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render UDSH addresses in monospace font
...
// Parse "ultradashcoin:" URI into recipient object, return true on successful parsing
