...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ultradash Coin Core ultradashcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ultradashcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ultradash coin transaction") + "\n" +
                               "  ultradashcoin-tx [options] -create [commands]   " + _("Create hex-encoded ultradash coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ultradash coin transaction
